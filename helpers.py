...
import os
import sys
#from web import graph  #commented out to avoid circular reference in imports and dependencies (web.py uses helpers also?)
...
if not os.path.exists(log_dir):
    try:  # todo figure out some more elegant way
        os.makedirs(log_dir)
        ...
        print("whatever - then no logging?")
